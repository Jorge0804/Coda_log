...
<head>
  ...
  <title>Coda logistica y transportes - Login</title>
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block" style="background-image: url('img/login_img.jpg'); background-size: cover;"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="{{url('/Iniciar')}}" method="POST">
                    ...
                    <button href="index.html" class="btn btn-primary btn-user btn-block" type="submit" style="background-color: #FF6600">
                      Login
                    </button>
                  </form>
                  <hr>
